        ...
        {campaigns.length === 0 ? (
          ...
          >
            {campaigns.map(campaign => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: expanded[campaign.id] ? "20px" : "0" }}>
                  ...
                  <button 
                    ...
                    style={{
                      background: expanded[campaign.id] ? "rgba(198,40,40,0.1)" : "var(--primary)",
                      color: expanded[campaign.id] ? "var(--primary)" : "#fff",
                      border: "none",
                      padding: "8px 16px",
                      borderRadius: "8px",
                      fontSize: "0.85rem",
                  ...
                  >
                    {expanded[campaign.id] ? "Hide Assets ▲" : "View Assets ▼"}
                  </button>
                </div>
